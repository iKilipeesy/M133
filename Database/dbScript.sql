...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 04. Dez 2019 um 11:34
...
CREATE TABLE `role` (
  ...
  `rCreatePost` int(11) NOT NULL,
  `rDeletePost` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- Datenbank: `m133a100`
--
CREATE DATABASE IF NOT EXISTS `m133a100` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `m133a100`;
...
--
-- Daten für Tabelle `messageboard`
--

INSERT INTO `messageboard` (`id`, `name`, `email`, `message`, `datum`) VALUES
(1, 'Kenny', 'kenny@email.com', 'Kennymessage', '2019-11-19'),
(2, 'Ich', 'ich@email.com', 'ichmesage', '2019-11-19'),
(3, 'Jan', 'jan@email.com', 'Janmessage', '2019-11-14'),
(4, 'Peter', 'peter@email.com', 'peterMessage', '2019-11-19'),
(5, 'Lion', 'lion@email.com', 'lionmessage', '2019-11-18');
...
--
-- Indizes für die Tabelle `messageboard`
--
...
--
-- AUTO_INCREMENT für Tabelle `messageboard`
--
ALTER TABLE `messageboard`
...
('root', '[{\"db\":\"blog\",\"table\":\"role\"},{\"db\":\"blog\",\"table\":\"user\"},{\"db\":\"blog\",\"table\":\"post\"},{\"db\":\"blog\",\"table\":\"Post\"},{\"db\":\"m133a100\",\"table\":\"messageboard\"}]');
...
('root', '2019-12-04 10:33:37', '{\"lang\":\"de\",\"Console\\/Mode\":\"collapse\"}');
